...
#################################################
set output '../figs/tp_scores_vs_ARCIS_years.eps'
...
# X-axis
set xlabel ""
set xrange [1979:2015]
#set xtics rotate by 45 right
#################################################
set title "Total annual precipitation (ARCIS)"

set datafile separator ";"

set label '(a)' at graph 0.01,1.09 font ",18"
#################################################
plot '../res/tp_RMSE_vs_ARCIS_years.csv' using 1:2 with linespoints linestyle 1 title "ERA5-Land", \
...
#################################################
plot '../res/tp_ME_vs_ARCIS_years.csv' using 1:2 with linespoints linestyle 1 notitle, \
...
#################################################
plot '../res/tp_MBIAS_vs_ARCIS_years.csv' using 1:2 with linespoints linestyle 1 notitle, \
                                        '' using 1:3 with linespoints linestyle 2 notitle, \
                                        '' using 1:4 with linespoints linestyle 3 notitle 
unset label
...
#################################################
plot '../res/tp_CORR_vs_ARCIS_years.csv' using 1:2 with linespoints linestyle 1 notitle, \
                                       '' using 1:3 with linespoints linestyle 2 notitle, \
                                       '' using 1:4 with linespoints linestyle 3 notitle 
unset label
